...
- **Khalil, H. K. — *Control Systems: An Introduction*.** Primary. Chapters 1–6
  map onto Weeks 1–12.
- **Nise, N. S. — *Control Systems Engineering*, 6th edition.** Secondary, and
  the source for signal flow graphs and Mason's rule (§5.4–5.5) and the Nichols
  chart (§10.9). Large problem bank; also spans FEE3412.
- **Nagrath, I. J. & Gopal, M. — *Control Systems Engineering*, 2nd edition.**
  The source for the actuator hardware in Week 1, and the clearest account of
  contour mapping (§9.2) for Week 11.
